				...
				<fieldset>
						<div class="row">
							<div class="abb-form-row">
								<div class="col-xs-6">
									<input type="text" class="form-control"  placeholder="Dns Adress" name="dnsadgeldi" required=""> </input>
								</div>
							</div>
						...
						<div class="abb-form-row">
							<input type="text" class="form-control"  placeholder="IP Adress" name="dnsipgeldi" required=""> </input>
						</div> <br>
						
						<div class="abb-form-row">
							<input type="text" class="form-control"  placeholder="Port" name="dnsportgeldi" required=""> </input>
						</div> <br>
						<center>
							<div class="abb-form-row">
								<input type="submit" value="Create DNS" class="btn btn-default" onkeydown="return false" required="">
							</div>
						</center>
				</fieldset>
			</form>
